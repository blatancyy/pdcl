...
exports.run = (client, message, args) => {
    ...
    let author = `<@${authorEntry.id}> | **Level: ${client.utils.get("calculateLevelData")(authorEntry.xp).level}** | **Total XP: ${authorEntry.xp > 1000 ? authorEntry.xp / 1000 + "k" : authorEntry.xp}**.`;    
